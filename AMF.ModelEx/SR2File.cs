...
namespace AMF.TheLostWorlds.CDObjects
{
    public abstract class SR2Model : SRModel
    {
        ...
        protected SR2Model(BinaryReader xReader, UInt32 uDataStart, UInt32 uModelData, String strModelName, Platform ePlatform) :
    ...
    public class SR2File : SRFile
    {
        ...
        protected class SR2ObjectModel : SR2Model
        {
            ...
            protected SR2ObjectModel(BinaryReader xReader, UInt32 uDataStart, UInt32 uModelData, String strModelName, Platform ePlatform)
                : base (xReader, uDataStart, uModelData, strModelName, ePlatform)
            {
            ...
            public static SR2ObjectModel Load(BinaryReader xReader, UInt32 uDataStart, UInt32 uModelData, String strModelName, Platform ePlatform, UInt16 usIndex)
            {
                ...
                SR2ObjectModel xModel = new SR2ObjectModel(xReader, uDataStart, uModelData, strModelName, ePlatform);
        ...
        protected class SR2UnitModel : SR2Model
        {
            ...
            protected SR2UnitModel(BinaryReader xReader, UInt32 uDataStart, UInt32 uModelData, String strModelName, Platform ePlatform, Realm eRealm)
                : base (xReader, uDataStart, uModelData, strModelName, ePlatform)
            {
                m_eRealm                    = eRealm;
                // xReader.BaseStream.Position += 0x04;
            ...
            public static SR2UnitModel Load(BinaryReader xReader, UInt32 uDataStart, UInt32 uModelData, String strModelName, Platform ePlatform, Realm eRealm)
            {
                SR2UnitModel xModel = new SR2UnitModel(xReader, uDataStart, uModelData, strModelName, ePlatform, eRealm);
                xModel.ReadData(xReader);
                return xModel;
            }
        ...
        protected override void ReadObjectData(BinaryReader xReader)
        {
            ...
            {
                m_axModels[m] = SR2ObjectModel.Load(xReader, m_uDataStart, m_uModelStart, m_strModelName, m_ePlatform, m);
            }
        }
        ...
        protected override void ReadUnitData(BinaryReader xReader)
        {
            ...
            // Material data
            m_axModels[0] = SR2UnitModel.Load(xReader, m_uDataStart, m_uModelData, m_strModelName, m_ePlatform, Realm.Material);

            // Spectral data
            m_axModels[1] = SR2UnitModel.Load(xReader, m_uDataStart, m_uModelData, m_strModelName, m_ePlatform, Realm.Spectral);
